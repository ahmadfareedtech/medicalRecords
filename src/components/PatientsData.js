...
const rows = [
    ...
    { id: 7, lastName: 'Clifford', firstName: 'Ferrara', age: 44, report: 'CBC' },
    { id: 8, lastName: 'Frances', firstName: 'Rossini', age: 36, report: 'CBC' },
    { id: 9, lastName: 'Roxie', firstName: 'Harvey', age: 65, report: 'CBC' },
];
